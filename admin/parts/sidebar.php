...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <div class="sidebar-brand-text mx-3">Дрво Администрација</div>
  </a>
  ...
  <!-- Nav Item - Pages Collapse Menu -->
  <li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#brands" aria-expanded="true" aria-controls="collapsePages">
      <i class="fas fa-fw fa-folder"></i>
      <span>Произвођачи</span>
    </a>
    <div id="brands" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Управљање</h6>
        <a class="collapse-item" href="add-brand.php">Додај произвођача</a>
        <a class="collapse-item" href="brands.php">Прегледај све</a>
      </div>
    </div>
  </li>
  ...
  <li class="nav-item">
    ...
    <div id="products" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
      <div class="bg-white py-2 collapse-inner rounded">
        <h6 class="collapse-header">Управљање</h6>
        <a class="collapse-item" href="login.html">Додај производ</a>
